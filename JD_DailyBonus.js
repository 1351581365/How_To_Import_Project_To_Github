...
var Key = 'pt_key=AAJfgPn7ADA4OriTHK_lUXK-5sJRKR9StNtBkMkGmgCSaHx0rt1MzNnz_BbC9UNPp226wfbKukU;pt_pin=jd_6cd93e613b0e5;'; //单引号内自行填写您抓取的Cookie
    ...
    setTimeout(() => {
      $nobyda.get({
        ...
        try {
          ...
          const tm2 = zone == -480 ? new Date().setHours(0, 0, 0, 0) : new Date(Date.now()).setHours(0, 0, 0, 0);
